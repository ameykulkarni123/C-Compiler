...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','compiler.py',115),
  ('statement -> expression','statement',1,'p_statement_expr','compiler.py',280),
  ('expression -> expression + expression','expression',3,'p_expression_binop','compiler.py',283),
  ('expression -> expression - expression','expression',3,'p_expression_binop','compiler.py',284),
  ('expression -> expression * expression','expression',3,'p_expression_binop','compiler.py',285),
  ('expression -> expression / expression','expression',3,'p_expression_binop','compiler.py',286),
  ('expression -> expression % expression','expression',3,'p_expression_binop','compiler.py',287),
  ('expression -> expression LS expression','expression',3,'p_expression_binop','compiler.py',288),
  ('expression -> expression RS expression','expression',3,'p_expression_binop','compiler.py',289),
  ('expression -> expression < expression','expression',3,'p_expression_binop','compiler.py',290),
  ('expression -> expression > expression','expression',3,'p_expression_binop','compiler.py',291),
  ('statement -> expression ? statement : statement','statement',5,'p_expression_ternop','compiler.py',419),
  ('statement -> IF expression THEN statement ELSE statement','statement',6,'p_expression_ternop','compiler.py',420),
  ('expression -> ( expression )','expression',3,'p_expression_group','compiler.py',423),
  ('expression -> NUMBER','expression',1,'p_expression_number','compiler.py',430),
  ('expression -> NAME','expression',1,'p_expression_name','compiler.py',436),
]
