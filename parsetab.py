...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','arm_expression_compiler.py',115),
  ('statement -> expression','statement',1,'p_statement_expr','arm_expression_compiler.py',279),
  ('expression -> expression + expression','expression',3,'p_expression_binop','arm_expression_compiler.py',282),
  ('expression -> expression - expression','expression',3,'p_expression_binop','arm_expression_compiler.py',283),
  ('expression -> expression * expression','expression',3,'p_expression_binop','arm_expression_compiler.py',284),
  ('expression -> expression / expression','expression',3,'p_expression_binop','arm_expression_compiler.py',285),
  ('expression -> expression % expression','expression',3,'p_expression_binop','arm_expression_compiler.py',286),
  ('expression -> expression LS expression','expression',3,'p_expression_binop','arm_expression_compiler.py',287),
  ('expression -> expression RS expression','expression',3,'p_expression_binop','arm_expression_compiler.py',288),
  ('expression -> expression < expression','expression',3,'p_expression_binop','arm_expression_compiler.py',289),
  ('expression -> expression > expression','expression',3,'p_expression_binop','arm_expression_compiler.py',290),
  ('statement -> expression ? statement : statement','statement',5,'p_expression_ternop','arm_expression_compiler.py',419),
  ('statement -> IF expression THEN statement ELSE statement','statement',6,'p_expression_ternop','arm_expression_compiler.py',420),
  ('expression -> ( expression )','expression',3,'p_expression_group','arm_expression_compiler.py',423),
  ('expression -> NUMBER','expression',1,'p_expression_number','arm_expression_compiler.py',430),
  ('expression -> NAME','expression',1,'p_expression_name','arm_expression_compiler.py',436),
]
